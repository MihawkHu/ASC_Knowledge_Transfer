...
# onehot
python train_target.py --trans_way onehot --model resnet --lmd 1.0 --soft_ratio 0.0 --source_model ../ASC_Adaptation/exp_2020_resnet_baseline_source//model-62-0.7909.hdf5 --device ${device}
python train_target.py --trans_way onehot --model fcnn --lmd 1.0 --soft_ratio 0.0 --source_model ../ASC_Adaptation/exp_2020_fcnn_baseline_source//model-62-0.7939.hdf5 --device ${device}
